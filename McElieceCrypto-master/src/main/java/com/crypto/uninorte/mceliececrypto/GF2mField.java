 ...
 * poly(A) ) All operations are defined only for field with 1&lt; m &lt;32. For
 * the representation of field elements the map f: F-&gt;Z, poly(A)-&gt;poly(2)
 * is used, where integers have the binary representation. For example:
 * A^7+A^3+A+1 -&gt; (00...0010001011)=139 Also for elements type Integer is
 * used.
 *
