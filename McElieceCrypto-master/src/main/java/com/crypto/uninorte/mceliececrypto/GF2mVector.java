...
public class GF2mVector
     ...
     */
    /**
     * Create a new vector over <tt>GF(2<sup>m</sup>)</tt> of the given length
     * and element array.
     *
     ...
     * @throws ArithmeticException if the other vector is not defined over the
     * same field as this vector.
     * <p>
