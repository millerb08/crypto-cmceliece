...
public class PolynomialGF2mSmallM {
     ...
     * represented as int (see {@link GF2mField}). The polynomials are stored as
     * int arrays.
     */
     ...
     * @throws ArithmeticException if <tt>element</tt> is not an element of the
     * finite field this polynomial is defined over.
     */
     ...
     * @return <tt>this^2</tt> modulo the reduction polynomial implicitly given
     * via the squaring matrix
     */
     ...
     *
     * @param g the reduction polynomial
     * @return PolynomialGF2mSmallM[] {a,b} with b*this = a mod g and
     * deg(a)&lt;= deg(g)/2
     */
     ...
     * @param a the first polynomial
     * @param b the second polynomial
     * @return <tt>true</tt> if <tt>a</tt> and <tt>b</tt> represent the same
     * polynomials, <tt>false</tt> otherwise
     */
     ...
     *
     * @param a the polynomial
     * @return the degree of the polynomial <tt>a</tt>. If <tt>a</tt> is the
     * zero polynomial, return -1.
     */
